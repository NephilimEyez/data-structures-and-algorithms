...
const addValues = (arr) => arr.reduce((acc, currentValue) => acc + currentValue, 0);
...
const addPurchases = (arr) => arr.reduce((acc, currentValue) => acc + currentValue.purchasePrice, 0);
...
const returnNames = (arr) => {
  let names = arr.reduce((acc, currentValue) => {
...
const reversedString = (str) => str.split('').reduce((acc, currentValue) => currentValue + acc, '');
